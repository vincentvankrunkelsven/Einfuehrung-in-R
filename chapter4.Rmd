...
title       : Faktoren
description : Sehr oft fallen Daten in eine begrenzte Anzahl von Kategorien. Zum Beispiel sind Menschen entweder maennlich oder weiblich. In R werden kategoriale Daten in Faktoren gespeichert. 
In Anbetracht der grossen Bedeutung dieser Faktoren bei der Datenanalyse, sollten Sie anfangen zu lernen, wie sie erstellt, unterteilt und verglichen werden.
